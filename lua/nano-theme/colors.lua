...
function M.get()
  ...
  local nano_background_color = is_light_theme and "#212529" or "#ECEFF4"
  --local nano_foreground_color = is_light_theme and "#37474F" or "#ECEFF4"
  local nano_foreground_color = is_light_theme and "#F7F7F7" or "#2E3440"
  ...
  local nano_salient_color    = is_light_theme and "#3250a0" or "#81A1C1"
  --local nano_salient_color    = is_light_theme and "#325CC0" or "#81A1C1"
  local nano_strong_color     = is_light_theme and "#325FFF" or "#FFFFFF"
